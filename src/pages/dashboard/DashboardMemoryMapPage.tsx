...
export default function DashboardMemoryMapPage() {
  ...
  return (
    <div className="lg:col-span-10">
      <DashboardHeader 
        title="Memory Map" 
        description="Explore places and create location-based memories"
      />
      ...
      <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <div>
                ...
                {selectedPlace.rating && (
                  <div className="flex items-center mt-2">
                    ...
                    <span className="text-sm text-gray-600 ml-1">{selectedPlace.rating}/5</span>
                  </div>
                )}
              </div>
              <button
            ...
            {isAddingMemory && (
              <div className="border-t pt-4">
                <h4 className="font-medium text-gray-900 mb-2">Add a Memory Note</h4>
                <textarea
                  value={memoryNote}
                  onChange={(e) => setMemoryNote(e.target.value)}
                  placeholder="What memories do you have of this place?"
        ...
        {savedLocations.length > 0 && (
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Saved Memories</h3>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {savedLocations.map((location) => (
                <div key={location.id} className="border border-gray-200 rounded-lg p-4">
                  ...
                  {location.visit_date && (
                    <p className="text-xs text-gray-500 mt-2">Visited: {location.visit_date}</p>
                  )}
                  <button
