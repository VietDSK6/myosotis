  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-[#F9F9FB] antialiased text-[#333333] flex">
        {/* Notification */}
        {showNotification && (
          <div className="fixed top-4 right-2 z-50 bg-blue-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center space-x-2">
        ...
        {/* Sidebar */}
        <div className="w-full lg:w-2/12 bg-white">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <header className="bg-white py-4 border-l border-gray-100">
          ...
          {/* Page Content */}
          <div className="flex-1 px-4 sm:px-6 lg:px-8 py-6 bg-white border-l border-gray-100">
            <Outlet />
          </div>
        </div>
      </div>
