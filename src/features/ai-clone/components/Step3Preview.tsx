...
export default function Step3Preview() {
  ...
  }, [characterPhoto, referenceAudio, referenceText, user?.id, scriptMode, currentScript, topic, keywords, description, updateData]);
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">
          {scriptMode === 'ai-generated' ? 'Generating Your Living Memory' : 'Preview Your Living Memory'}
        </h2>
        <p className="text-lg text-gray-600">
          {scriptMode === 'ai-generated' 
            ? 'AI is creating your personalized character video' 
            : 'Review and finalize your AI character'
          }
        </p>
      </div>
          ...
          <div className="lg:w-1/2">
                  ...
                  {scriptMode === 'ai-generated' && (
                    <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40">
                      <div className="text-center text-white">
                        ...
                        <p className="text-sm">Video will auto-generate</p>
                      </div>
                    </div>
                  )}
                </div>
            ...
            {characterPhoto && (
              <div className="mt-4 text-sm text-gray-600">
                <p><span className="font-bold">Image:</span> {characterPhoto.name}</p>
                {referenceAudio && (
                  <p><span className="font-bold">Voice:</span> {referenceAudio.name}</p>
                )}
              </div>
            )}
          </div>
          ...
          {(scriptMode === 'manual' || (scriptMode === 'ai-generated' && currentScript)) && (
            <div className="lg:w-1/2">
              ...
              <textarea
                ...
                placeholder={scriptMode === 'ai-generated' ? 'AI is generating your script...' : 'Your script will appear here...'}
              />
              
              <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                <span>
                  {scriptMode === 'manual' 
                    ? 'You can edit the script before generating' 
