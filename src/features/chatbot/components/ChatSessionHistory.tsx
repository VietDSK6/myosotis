          ...
          <div className="p-2">
            {sessionHistory.map((session) => (
              <div
                ...
                className={`relative mb-2 rounded-lg transition-colors duration-200
              ...
              >
                <button
                  ...
                  className="w-full text-left p-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#92d7e7]/50"
                >
