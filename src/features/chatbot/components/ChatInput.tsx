...
export const ChatInput: React.FC = () => {
  ...
  return (
    <div className="border-t border-gray-200 bg-white p-3 sm:p-6">
      <form onSubmit={handleSubmit} className="flex gap-2 sm:gap-4 items-end">
        <div className="flex-1">
          <textarea
            ...
            disabled={isSending}
            rows={1}
            className="w-full px-3 sm:px-6 py-3 sm:py-4 text-sm sm:text-lg border border-gray-300 rounded-2xl 
                       focus:outline-none focus:ring-2 focus:ring-[#92d7e7]/50 
                       focus:border-[#92d7e7] resize-none min-h-[48px] sm:min-h-[56px] max-h-32
        ...
        <button
          ...
          className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-[#92d7e7] hover:bg-[#7bc7d9] 
